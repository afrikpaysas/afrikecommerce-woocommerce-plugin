...
?>
<form id="dataFormPAYPAL" action="<?php echo $_GET["urlafrikpay"]; ?>" method="post" target="_top">
...
<script type="text/javascript">
    document.getElementById('dataFormPAYPAL').submit(); // SUBMIT FORM
</script>
<?php
...
class WC_Gateway_PAYPAL extends WC_Payment_Gateway {
	...
	protected function get_icon_image( $country ) {
		switch ( $country ) {
			default :
				$icon = WC_HTTPS::force_https_url( '../assets/images/paypal.png' );
			break;
		}
	...
	public function is_valid_for_use() {
		return in_array( get_woocommerce_currency(), apply_filters( 'woocommerce_paypal_supported_currencies', array( 'XAF','USD','EUR' ) ) );
	}
