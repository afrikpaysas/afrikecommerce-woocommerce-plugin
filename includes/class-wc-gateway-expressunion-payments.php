...
class WC_Gateway_EU extends WC_Payment_Gateway {
	...
	public function get_icon() {
		...
		foreach ( $icon as $i ) {
			$icon_html .= '<img style="width : 50px ; height : 50px" src="' . esc_attr( $i ) . '" alt="' . esc_attr__( '', 'woocommerce' ) . '" />';
		}
	...
	public function is_valid_for_use() {
		return in_array( get_woocommerce_currency(), apply_filters( 'woocommerce_expressunion_supported_currencies', array( 'XAF','USD','EUR','CFA' ) ) );
	}
