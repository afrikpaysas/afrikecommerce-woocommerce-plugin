...
class WC_Gateway_Afrikpay extends WC_Payment_Gateway {
	...
	public function is_valid_for_use() {
		return in_array( get_woocommerce_currency(), apply_filters( 'woocommerce_afrikpay_supported_currencies', array( 'XAF','USD','EUR','CFA','XOF' ) ) );
	}
...
$error=$_GET["error"];
	...
	public function admin_scripts() {
		...
		wp_enqueue_script( 'woocommerce_afrikpay_admin', '../wp-content/plugins/afrikecommerce-payments-for-woocommerce/assets/js/afrikpay-admin' . $suffix . '.js', array(), WC_VERSION, true );
	}
}
}
