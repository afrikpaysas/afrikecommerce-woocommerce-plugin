...
class WC_Gateway_OM extends WC_Payment_Gateway {
	...
	protected function get_icon_image( $country ) {
		switch ( $country ) {
			default :
				$icon = WC_HTTPS::force_https_url( 'https://cloud.afrikpay.com/images/partners/om.png' );
			break;
		}
	...
	public function is_valid_for_use() {
		return in_array( get_woocommerce_currency(), apply_filters( 'woocommerce_orangemoney_supported_currencies', array( 'XAF','USD','EUR' ) ) );
	}
...
$error=$_GET["error"];
	...
	public function admin_scripts() {
		...
		wp_enqueue_script( 'woocommerce_orangemoney_admin', '../wp-content/plugins/afrikecommerce-payments-for-woocommerce/assets/js/afrikpay-admin' . $suffix . '.js', array(), WC_VERSION, true );
	}
}
}
